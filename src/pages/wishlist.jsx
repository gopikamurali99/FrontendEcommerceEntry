          ...
          {wishlistItems.map(item => (
            ...
            <div key={item._id} className="border rounded-lg p-4 shadow-md">
              ...
              <button onClick={()=> addToCart({
                  ...
                  }, item.sizes).then(() => removeFromWishlist(item._id)).catch((error) => console.error('Error adding to cart:', error))}className="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
             Add To cart
              </button>
            </div>
